...
\hlstd{}\hlsymbol{pars}{\ }\hlassignement{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlargument{Xo}{\ }\hlargument{=}{\ }\hlnumber{730}\hlkeyword{,}{\ }\hlargument{e}{\ }\hlargument{=}{\ }\hlnumber{0.5}\hlkeyword{,}{\ }\hlargument{a}{\ }\hlargument{=}{\ }\hlnumber{100}\hlkeyword{,}{\ }\hlargument{K}{\ }\hlargument{=}{\ }\hlnumber{1000}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{h}{\ }\hlargument{=}{\ }\hlnumber{200}\hlkeyword{,}{\ }\hlargument{i}{\ }\hlargument{=}{\ }\hlnumber{0}\hlkeyword{,}{\ }\hlargument{Da}{\ }\hlargument{=}{\ }\hlnumber{0.09}\hlkeyword{,}{\ }\hlargument{Dt}{\ }\hlargument{=}{\ }\hlnumber{0}\hlkeyword{,}{\ }\hlargument{p}{\ }\hlargument{=}{\ }\hlnumber{2}\hlkeyword{)}\hspace*{\fill}\\
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{acorr}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{summary\usebox{\hlnormalsizeboxunderscore}statistic}\hlkeyword{(}\hlsymbol{dat}\hlkeyword{,}{\ }\hlsymbol{window\usebox{\hlnormalsizeboxunderscore}autocorr}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{windowsize}{\ }\hlargument{=}{\ }\hlfunctioncall{length}\hlkeyword{(}\hlsymbol{time}\hlkeyword{)}\hlkeyword{/}\hlnumber{2}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}}
\end{knitrout}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{ggplot}\hlkeyword{(}\hlsymbol{acorr}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{geom\usebox{\hlnormalsizeboxunderscore}line}\hlkeyword{(}\hlfunctioncall{aes}\hlkeyword{(}\hlsymbol{time}\hlkeyword{,}{\ }\hlsymbol{value}\hlkeyword{)}\hlkeyword{)}{\ }\hlkeyword{+}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlfunctioncall{facet\usebox{\hlnormalsizeboxunderscore}wrap}\hlkeyword{(}\hlkeyword{\urltilda{}}\hlsymbol{reps}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{opts}\hlkeyword{(}\hlargument{title}{\ }\hlargument{=}{\ }\hlstring{"{}Autocorrelation{\ }on{\ }replicates{\ }from{\ }a{\ }system{\ }approaching{\ }a{\ }crash"{}}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{reps}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{sfLapply}\hlkeyword{(}\hlnumber{1}\hlkeyword{:}\hlnumber{500}\hlkeyword{,}{\ }\hlkeyword{function}\hlkeyword{(}\hlformalargs{i}\hlkeyword{)}{\ }\hlfunctioncall{compare}\hlkeyword{(}\hlsymbol{A}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlsymbol{B}\hlkeyword{)}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}}
\end{knitrout}
...
\hlstd{}\hlfunctioncall{ggplot}\hlkeyword{(}\hlsymbol{lr}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{geom\usebox{\hlnormalsizeboxunderscore}density}\hlkeyword{(}\hlfunctioncall{aes}\hlkeyword{(}\hlsymbol{value}\hlkeyword{,}{\ }\hlargument{fill}{\ }\hlargument{=}{\ }\hlsymbol{simulation}\hlkeyword{)}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{alpha}{\ }\hlargument{=}{\ }\hlnumber{0.7}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{geom\usebox{\hlnormalsizeboxunderscore}vline}\hlkeyword{(}\hlargument{xintercept}{\ }\hlargument{=}{\ }\hlsymbol{observed}\hlkeyword{,}{\ }\hlargument{lty}{\ }\hlargument{=}{\ }\hlnumber{2}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\hlstd{}\hlfunctioncall{beanplot}\hlkeyword{(}\hlsymbol{value}{\ }\hlkeyword{\urltilda{}}{\ }\hlsymbol{simulation}\hlkeyword{,}{\ }\hlsymbol{lr}\hlkeyword{,}{\ }\hlargument{what}{\ }\hlargument{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlnumber{0}\hlkeyword{,}{\ }\hlnumber{1}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlnumber{0}\hlkeyword{,}{\ }\hlnumber{0}\hlkeyword{)}\hlkeyword{)}\hspace*{\fill}\\
...
\hlstd{}\hlfunctioncall{ggplot}\hlkeyword{(}\hlsymbol{roc}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{geom\usebox{\hlnormalsizeboxunderscore}line}\hlkeyword{(}\hlfunctioncall{aes}\hlkeyword{(}\hlsymbol{False.positives}\hlkeyword{,}{\ }\hlsymbol{True.positives}\hlkeyword{)}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{lwd}{\ }\hlargument{=}{\ }\hlnumber{1}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\hlstd{}\hlfunctioncall{ggplot}\hlkeyword{(}\hlfunctioncall{subset}\hlkeyword{(}\hlsymbol{pars}\hlkeyword{,}{\ }\hlsymbol{fit}{\ }\hlkeyword{\usebox{\hlnormalsizeboxpercent}in\usebox{\hlnormalsizeboxpercent}}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlstring{"{}AA"{}}\hlkeyword{,}{\ }\hlstring{"{}BB"{}}\hlkeyword{)}\hlkeyword{)}\hlkeyword{,}{\ }\hlfunctioncall{aes}\hlkeyword{(}\hlsymbol{fit}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlsymbol{value}\hlkeyword{)}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{stat\usebox{\hlnormalsizeboxunderscore}summary}\hlkeyword{(}\hlargument{fun.y}{\ }\hlargument{=}{\ }\hlsymbol{mean}\hlkeyword{,}{\ }\hlargument{geom}{\ }\hlargument{=}{\ }\hlstring{"{}bar"{}}\hlkeyword{,}{\ }\hlargument{position}{\ }\hlargument{=}{\ }\hlstring{"{}dodge"{}}\hlkeyword{)}{\ }\hlkeyword{+}\hspace*{\fill}\\
...
\hlstd{}{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }\hlargument{position}{\ }\hlargument{=}{\ }\hlfunctioncall{position\usebox{\hlnormalsizeboxunderscore}dodge}\hlkeyword{(}\hlargument{width}{\ }\hlargument{=}{\ }\hlnumber{0.9}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{conf.int}{\ }\hlargument{=}{\ }\hlnumber{0.95}\hlkeyword{)}{\ }\hlkeyword{+}\hspace*{\fill}\\
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{sims}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{get\usebox{\hlnormalsizeboxunderscore}replicates}\hlkeyword{(}\hlsymbol{reps}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{ggplot}\hlkeyword{(}\hlsymbol{sims}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{geom\usebox{\hlnormalsizeboxunderscore}line}\hlkeyword{(}\hlfunctioncall{aes}\hlkeyword{(}\hlsymbol{time}\hlkeyword{,}{\ }\hlsymbol{value}\hlkeyword{,}{\ }\hlargument{group}{\ }\hlargument{=}{\ }\hlsymbol{rep}\hlkeyword{)}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{alpha}{\ }\hlargument{=}{\ }\hlnumber{0.1}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{facet\usebox{\hlnormalsizeboxunderscore}wrap}\hlkeyword{(}\hlkeyword{\urltilda{}}\hlsymbol{model}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
...
\hlstd{}\hlsymbol{autocorrelation}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{window\usebox{\hlnormalsizeboxunderscore}autocorr}\hlkeyword{(}\hlsymbol{X}\hlkeyword{[[}\hlstring{"{}value"{}}\hlkeyword{]}\hlkeyword{]}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{windowsize}{\ }\hlargument{=}{\ }\hlsymbol{npts}\hlkeyword{/}\hlnumber{2}\hlkeyword{)}\hspace*{\fill}\\
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{reps}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlnumber{500}\hspace*{\fill}\\
\hlstd{}\hlsymbol{Asim}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{simulate}\hlkeyword{(}\hlsymbol{A}\hlkeyword{,}{\ }\hlsymbol{reps}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{Bsim}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{simulate}\hlkeyword{(}\hlsymbol{B}\hlkeyword{,}{\ }\hlsymbol{reps}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}}
\end{knitrout}
...
\hlstd{}\hlsymbol{wsA}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{ddply}\hlkeyword{(}\hlsymbol{Asim}\hlkeyword{,}{\ }\hlstring{"{}reps"{}}\hlkeyword{,}{\ }\hlsymbol{warningtrend}\hlkeyword{,}{\ }\hlsymbol{window\usebox{\hlnormalsizeboxunderscore}autocorr}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{.parallel}{\ }\hlargument{=}{\ }\hlnumber{TRUE}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{wsB}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{ddply}\hlkeyword{(}\hlsymbol{Bsim}\hlkeyword{,}{\ }\hlstring{"{}reps"{}}\hlkeyword{,}{\ }\hlsymbol{warningtrend}\hlkeyword{,}{\ }\hlsymbol{window\usebox{\hlnormalsizeboxunderscore}autocorr}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{.parallel}{\ }\hlargument{=}{\ }\hlnumber{TRUE}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
\end{kframe}}
\end{knitrout}
...
\hlstd{}\hlfunctioncall{beanplot}\hlkeyword{(}\hlsymbol{value}{\ }\hlkeyword{\urltilda{}}{\ }\hlsymbol{simulation}\hlkeyword{,}{\ }\hlsymbol{tidy}\hlkeyword{,}{\ }\hlargument{what}{\ }\hlargument{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlnumber{0}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlnumber{1}\hlkeyword{,}{\ }\hlnumber{0}\hlkeyword{,}{\ }\hlnumber{0}\hlkeyword{)}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{abline}\hlkeyword{(}\hlargument{h}{\ }\hlargument{=}{\ }\hlsymbol{observed}\hlkeyword{,}{\ }\hlargument{lty}{\ }\hlargument{=}{\ }\hlnumber{2}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
