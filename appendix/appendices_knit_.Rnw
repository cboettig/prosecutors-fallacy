...
We begin by running the individual based simulation, supplied in our helper package, populationdynamics, with 500 sample points, instead of the 40 shown in the text.   
