...
% Should we also mention that some popular approaches such as autocorrelation require evenly-spaced points,
% and interpolating is incorrect, introducing fictitious correlations?

\textbf{no quantitative measures}\\
...
\textbf{problem of null models}\\
Specifying an appropriate null model is difficult.  
