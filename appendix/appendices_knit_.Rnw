...
% \SweaveOpts{fig.width=4, fig.height=4, fig.align=center, message=FALSE, warning=FALSE, tidy=FALSE, cache=TRUE}
...
Simulate from a system approaching a collapse~\Sexpr{nreps} times using our population dynamics package, available at \href{https://github.com/cboettig/populationdynamics}{https://github.com/cboettig/populationdynamics},
...
\begin{figure}[H]
\begin{center}
<<crashacor, fig.width=7, fig.height=7>>=
...
<<moresims>>=
nreps <- 500
Asim <- simulate(A, nreps)
Bsim <- simulate(B, nreps)
@
