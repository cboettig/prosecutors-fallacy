...
Foundational work on early warning signals has operated under the often-implicit assumption that the system dynamics contain a saddle-node bifurcation and looks for patterns that would be associated with approaching this bifurcation point.  Such methods  

\subsection{Explicit use of the model}
Detection of warning signals as model choice (``non-parametric'' Carpenter \& Brock, unpublished Dakos, Kuehn arxiv, Dakos 2011?, Gross 2011)
